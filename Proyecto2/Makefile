...
$U/sh.o: $U/sh.c
	$(CC) $(CFLAGS) -c -o $U/sh.o $U/sh.c

$U/parser.o: $U/parser.c
	$(CC) $(CFLAGS) -c -o $U/parser.o $U/parser.c

$U/commands.o: $U/commands.c
	$(CC) $(CFLAGS) -c -o $U/commands.o $U/commands.c
$U/usys.S : $U/usys.pl
...
QEMUOPTS = -machine virt -bios none -kernel $K/kernel -m 128M -smp $(CPUS) -serial vc
